...
const Footer = () => {
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='flex container mx-auto flex-col md:flex-row justify-between items-start'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0 '>
                <img src={assets.logo_dark} alt="" />
                <p className='mt-4 text-gray-400'>Lorem Ipsum is simply dummy text of the printing and
            ...
            <div className='w-full md:w-1/3'>
                ...
                <p className='text-gray-400 mb-4 max-w-80'>
                    the latest news, articles, and resources, and resources, sent
        ...
        <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
            Copyright 2025 © Shopo.com - All Right Reserved.
        </div>
    </div>
  )
}
